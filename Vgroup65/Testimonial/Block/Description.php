...
class Description extends \Magento\Framework\View\Element\Template
{
    ...
    protected function _prepareLayout() { 
        ...
        $breadcrumbs->addCrumb($configuration['top_menu_link'], array('label'=>$configuration['top_menu_link'], 'title'=> $configuration['top_menu_link'], 'link'=>$this->getUrl('testimonial/')));
        ...
        $breadcrumbs->addCrumb($testimonialName, array('label'=>$testimonialName, 'title'=> $configuration['top_menu_link'], 'link'=>$this->getUrl('testimonial/view/detail/', array('testimonial'=> $testimonialId))));
        endif;
