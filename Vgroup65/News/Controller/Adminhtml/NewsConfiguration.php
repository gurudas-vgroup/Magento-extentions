...
use Vgroup65\News\Model\NewsConfigurationFactory;
 
abstract class NewsConfiguration extends \Magento\Backend\App\Action
//class News extends Action
{
    ...
    public function __construct(
        ...
        NewsConfigurationFactory $newsConfigurationFactory
    ) {
