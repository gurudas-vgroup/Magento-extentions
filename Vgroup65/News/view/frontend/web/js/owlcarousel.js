...
!(function ($) {
    ;(function (jQuery, window, document, undefined) {
        ...
        function Owl(element, options)
        {
          ...
          *
            ...
            jQuery.each(
                [ 'onResize', 'onThrottledResize' ], jQuery.proxy(
                    function (i, handler) {
        ...
        Owl.prototype.onDragStart = function (event) {
            ...
            jQuery(document).one(
                'mousemove.owl.core touchmove.owl.core', jQuery.proxy(
                    function (event) {
        ...
        Owl.prototype.coordinates = function (position) {
            ...
            if (position === undefined) {
                return jQuery.map(
                    this._coordinates, jQuery.proxy(
        ...
        Owl.prototype.enter = function (name) {
            jQuery.each(
                [ name ].concat(this._states.tags[name] || []), jQuery.proxy(
                    function (i, name) {
        ...
        Owl.prototype.register = function (object) {
            if (object.type === Owl.Type.Event) {
                ...
                this._states.tags[object.name] = jQuery.grep(
                    this._states.tags[object.name], jQuery.proxy(
                        function (tag, i) {
                    ...
                    if (!data) {
                        ...
                        jQuery.each(
                            ...
                            'next', 'prev', 'to', 'destroy', 'refresh', 'replace', 'add', 'remove'
                                ...
                                data.jQueryelement.on(
                                    event + '.owl.carousel.core', jQuery.proxy(
                                        function (e) {
    ...
    ;(function (jQuery, window, document, undefined) {
        ...
        var AutoRefresh = function (carousel) {
          ...
          *
             ...
             */
            this._handlers = {
                'initialized.owl.carousel': jQuery.proxy(
                    function (e) {
    ...
    ;(function (jQuery, window, document, undefined) {
        ...
        var Lazy = function (carousel) {
          ...
          *
             ...
             */
            this._handlers = {
                'initialized.owl.carousel change.owl.carousel resized.owl.carousel': jQuery.proxy(
                    function (e) {
                        if (!e.namespace) {
                            return;
                        }
    ...
    ;(function (jQuery, window, document, undefined) {
        ...
        var AutoHeight = function (carousel) {
          ...
          *
             ...
             */
            this._handlers = {
                'initialized.owl.carousel refreshed.owl.carousel': jQuery.proxy(
                    function (e) {
            ...
            'changed.owl.carousel': jQuery.proxy(
                function (e) {
    ...
    ;(function (jQuery, window, document, undefined) {
        ...
        var Video = function (carousel) {
          ...
          *
            ...
            'resize.owl.carousel': jQuery.proxy(
                function (e) {
            ...
            'refreshed.owl.carousel': jQuery.proxy(
                function (e) {
            ...
            'prepared.owl.carousel': jQuery.proxy(
                function (e) {
                    if (!e.namespace) {
                         return;
                    }
            ...
            this._core.jQueryelement.on(
                'click.owl.video', '.owl-video-play-icon', jQuery.proxy(
                    function (e) {
                            this.play(e);
                    }, this
                )
    ...
    ;(function (jQuery, window, document, undefined) {
        ...
        var Animate = function (scope) {
            ...
            this.handlers = {
                'change.owl.carousel': jQuery.proxy(
                    function (e) {
            ...
            'drag.owl.carousel dragged.owl.carousel translated.owl.carousel': jQuery.proxy(
                function (e) {
                    if (e.namespace) {
            ...
            'translate.owl.carousel': jQuery.proxy(
                function (e) {
    ...
    ;(function (jQuery, window, document, undefined) {
        ...
        var Autoplay = function (carousel) {
          ...
          *
            ...
            'play.owl.autoplay': jQuery.proxy(
                function (e, t, s) {
                    if (e.namespace) {
                         this.play(t, s);
                    }
            ...
            'stop.owl.autoplay': jQuery.proxy(
                function (e) {
                    if (e.namespace) {
                         this.stop();
                    }
            ...
            'mouseover.owl.autoplay': jQuery.proxy(
                function () {
            ...
            'mouseleave.owl.autoplay': jQuery.proxy(
                function () {
                    if (this._core.settings.autoplayHoverPause && this._core.is('rotating')) {
                         this.play();
                    }
            ...
            'touchstart.owl.core': jQuery.proxy(
                function () {
                    if (this._core.settings.autoplayHoverPause && this._core.is('rotating')) {
                         this.pause();
                    }
            ...
            'touchend.owl.core': jQuery.proxy(
                function () {
    ...
    ;(function (jQuery, window, document, undefined) {
        ...
        var Navigation = function (carousel) {
          ...
          *
            ...
            'added.owl.carousel': jQuery.proxy(
                function (e) {
                    if (e.namespace && this._core.settings.dotsData) {
            ...
            'remove.owl.carousel': jQuery.proxy(
                function (e) {
                    if (e.namespace && this._core.settings.dotsData) {
    ...
    ;(function (jQuery, window, document, undefined) {
        ...
        var Hash = function (carousel) {
          ...
          *
            ...
            jQuery(window).on(
                'hashchange.owl.navigation', jQuery.proxy(
                    function (e) {
